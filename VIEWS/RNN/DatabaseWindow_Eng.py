...
# Form implementation generated from reading ui file 'RNN/Database_Eng.ui'
#
...
class Ui_DatabaseWindow_Eng(object):
    def setupUi(self, DatabaseWindow_Eng):
        DatabaseWindow_Eng.setObjectName("DatabaseWindow_Eng")
        DatabaseWindow_Eng.resize(650, 420)
        DatabaseWindow_Eng.setMinimumSize(QtCore.QSize(650, 420))
        DatabaseWindow_Eng.setMaximumSize(QtCore.QSize(650, 420))
        self.verticalLayoutWidget = QtWidgets.QWidget(DatabaseWindow_Eng)
        ...
        self.retranslateUi(DatabaseWindow_Eng)
        QtCore.QMetaObject.connectSlotsByName(DatabaseWindow_Eng)

    def retranslateUi(self, DatabaseWindow_Eng):
        _translate = QtCore.QCoreApplication.translate
        DatabaseWindow_Eng.setWindowTitle(_translate("DatabaseWindow_Eng", "DatabaseWindow"))
        item = self.modelsTable.horizontalHeaderItem(0)
        item.setText(_translate("DatabaseWindow_Eng", "Id"))
        item = self.modelsTable.horizontalHeaderItem(1)
        item.setText(_translate("DatabaseWindow_Eng", "Name"))
        item = self.modelsTable.horizontalHeaderItem(2)
        item.setText(_translate("DatabaseWindow_Eng", "From"))
        item = self.modelsTable.horizontalHeaderItem(3)
        item.setText(_translate("DatabaseWindow_Eng", "To"))
        self.label.setText(_translate("DatabaseWindow_Eng", "Model id:"))
        self.deleteButton.setText(_translate("DatabaseWindow_Eng", "Delete"))


if __name__ == "__main__":
    import sys
    app = QtWidgets.QApplication(sys.argv)
    DatabaseWindow_Eng = QtWidgets.QWidget()
    ui = Ui_DatabaseWindow_Eng()
    ui.setupUi(DatabaseWindow_Eng)
    DatabaseWindow_Eng.show()
    sys.exit(app.exec_())
